...
Sidharth served as the technical lead for this project, architecting and implementing the core systems that power the optimization engine and web application.
...
OR
@sidreyli and @chaneldebleu on telegram 
---
